<div>
    <h3 class="flex justify-center mt-8 text-xl">Calculate your needed calorie intake</h3>
    <form class="p-6 space-y-4" wire:submit='saveCalories' action="">
        @csrf
        <div class="grid grid-cols-2">
            <div>
                <label for="gender" class="block mx-2 mt-7">Gender</label>
            ...
            <div>
                <label for="age" class="block mx-2 mt-7">Age</label>
            ...
            <div>
                <label for="weight" class="block mx-2 mt-7">Weight in kg</label>
            ...
            <div>
                <label for="height" class="block mx-2 mt-7">Height in cm</label>
            ...
            <div>
                <label for="activity_level" class="block mx-2 mt-7">Activity level</label>
            ...
            <div>
                <label for="weight_goal" class="block mx-2 mt-7">Weight goal</label>
        ...
        <button class="rounder border border-gray-500 px-5 py-4 m-5 w-fit text-white bg-blue-950 hover:bg-blue-700 rounded-lg">Calculate</button>
    </form>
</div>
