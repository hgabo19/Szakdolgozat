<div>
    <div
        ...
        <div class="p-4 text-center">
            ...
            <h1 class="mb-5 text-xl font-extrabold text-white lg:text-4xl">Update workout plan</h1>
        </div>
            ...
            <form wire:submit.prevent="save">
                ...
                <div>
                    @foreach ($days as $dayIndex => $day)
                        <div>
                            <div>
                                <h1 class="text-2xl font-bold text-center text-white">Day {{ $dayIndex }}</h1>
                            </div>
                            <button
                            ...
                            <div class="md:flex md:flex-wrap md:gap-14">
                                @foreach ($day as $addedExerciseIndex => $addedExercise)
                                    <div class="flex flex-wrap gap-4 ml-4 w-fit md:w-1/3 md:flex-nowrap mr-14">
                                        <div>
                                            ...
                                            <select id="exercise"
                                                wire:model.blur="days.{{ $dayIndex }}.{{ $addedExerciseIndex }}.id"
