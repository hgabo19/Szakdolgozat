<div class="flex flex-col gap-4">
    <form class="flex items-center">   
        ...
        <div class="relative w-1/2 ml-4">
            ...
            <input type="text" wire:model.live.debounce.500ms ="search" id="simple-search" autocomplete="off" class="bg-gray-50 border border-gray-300
                ...
                focus:border-blue-500 block w-full ps-10 p-3 dark:bg-blue-950
                dark:border-blue-900 dark:placeholder-gray-400 dark:text-gray-200 
        ...
        <table class="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400 shadow-md">
            ...
            <tbody>
                ...
                <tr class="odd:bg-white odd:dark:bg-gray-900 even:bg-gray-50 even:dark:bg-gray-800">
                    ...
                    <td class="px-4 py-4">
                        <button wire:click="saveFoodToUser({{ $food->id }})">
    ...
    <div>
        <button x-data x-on:click="$dispatch('close-modal')" class="flex justify-center mx-auto mt-10 w-24 px-4 py-2 bg-action-color text-gray-200 font-semibold rounded hover:bg-action-hover hover:text-white">
            Done
        </button>
    </div>
</div>
